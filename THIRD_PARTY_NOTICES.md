...
See `docs/architecture/THIRD_PARTY_POLICY.md`, `docs/BLENDER_PIPELINE.md`, and `docs/research/OPEN_SOURCE_LIGHTING_LANDSCAPE.md` for the broader integration policy.
