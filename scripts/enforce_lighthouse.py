...
def enforce(report_dir: Path, config_path: Path) -> dict:
    ...
    for route in config["routes"]:
        for mode in MODES:
            ...
            try:
                ...
                errors.append(f"{route['id']} {mode}: unreadable Lighthouse report: {exc}")
                continue
    ...
    return {
        ...
        "errors": errors,
        "notes": [
            "This phase evaluates score budgets only after Lighthouse report production has succeeded.",
